...
The lowest value in the NSB matrix is represented as white, while the highest value in NSB matrix is set as black. On the right side of the out a gradient bar is displayed that indicates what the high and low values of the set are.
